...
namespace water
{
    ...
    /// control over which state is active and which states exist. We use smart pointers for the states to avoid possible
    /// access violate errors when a programmer gets a little trigger happy with delete!
    /// </summary>
    class IGameWorld
    {
        public:
